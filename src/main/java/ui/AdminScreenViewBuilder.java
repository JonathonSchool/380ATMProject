...
public class AdminScreenViewBuilder extends ViewBuilder {
    ...
    public AdminScreenViewBuilder(Model model, Runnable setCashHandler, Runnable openAtmHandler) {
        super(model);
    ...
    public Region build() {
        ...
        result.setBottom(adminButtonsPanel());
    ...
    private Region atmCashPane() {
        VBox center = new VBox(new Label("ATM's Current Cash:\n\n"),
                boundLabel(model.atmCashProperty()));
