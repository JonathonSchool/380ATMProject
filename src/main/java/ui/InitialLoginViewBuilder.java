...
public class InitialLoginViewBuilder extends ViewBuilder {
    ...
    public Region build() {
        ...
        result.setBottom(loginSubmitButton());
    ...
    public Node loginPanel() {
        ...
        HBox cardNumberQuery = new HBox(10, new Label("Card number: "), loginTextField(model.cardNumberInputProperty(), 16));
        cardNumberQuery.setAlignment(Pos.CENTER);

        HBox pinQuery = new HBox(10, new Label("PIN: "), loginTextField(model.pinInputProperty(), 3));
